...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Climate",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Climate11AppDelegate")
...
SWIFT_CLASS("_TtC7Climate13SceneDelegate")
...
SWIFT_CLASS("_TtC7Climate20SecondViewController")
@interface SecondViewController : UIViewController
- (IBAction)changeCityPressed:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC7Climate14ViewController")
@interface ViewController : UIViewController <CLLocationManagerDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified weatherImage;
- (IBAction)changeCityButton:(id _Nonnull)sender;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified thirdDayImage;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified secondDayImage;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified firstDayImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified thirdDayTempLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified secondDayTempLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified firstDayTempLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified thirdDayLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified secondDayLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified firstDayLabel;
